...
- [P01 GPT BUS_10 v1](P01_M30_Corporate/03_benchmark_runs/gpt_BUS_10_v1/README.md) — provisional exploratory run; strict provenance is not verified.
- [GPT P01 Series v1 summary](P01_M30_Corporate/03_benchmark_runs/GPT_P01_SERIES_V1_SUMMARY.md) — descriptive aggregation of BUS_01/03/05/09/10; not final cross-model evidence.
- [P01 checkpoint benchmark v1](P01_M30_Corporate/03_benchmark_runs/checkpoint_benchmark_v1/README.md) — six completed technical PNGs for mini-3/mini-5 at 750/1000/1250; no identity QA or ranking.
- [P01 PuLID multiscene v1](P01_M30_Corporate/03_benchmark_runs/pulid_multiscene_v1/README.md) — technical PuLID-only four-scene set: reused BUS_01 plus BUS_03, BUS_06/DESK and BUS_09/FULL; no cross-method comparison.
- [P01 local qualifier tail v1](P01_M30_Corporate/03_benchmark_runs/local_qualifier_tail_v1/README.md) — twelve completed mini-LoRA technical PNGs for BUS_06/DESK and BUS_09/FULL at mini-3/mini-5 checkpoints 750/1000/1250; no visual QA or ranking.
- [P01 FLUX Kontext qualifier v1](P01_M30_Corporate/03_benchmark_runs/flux_kontext_qualifier_v1/README.md) — three completed native FLUX.1 Kontext Dev reference-conditioned technical PNGs for BUS_01, BUS_06/DESK and BUS_09/FULL; no visual QA or ranking. The local Arena generation block is technically complete.
- [P01 FLUX Kontext repair v1](P01_M30_Corporate/03_benchmark_runs/flux_kontext_repair_v1/README.md) — separate two-image prompt-only anatomy repair for BUS_06/DESK and BUS_09/FULL. It preserves the official qualifier and its verified source artifacts; no visual QA or ranking.
