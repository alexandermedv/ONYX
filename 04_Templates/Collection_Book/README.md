...
```powershell
python "04_Templates/Collection_Book/test_renderer.py"
```
...
See [data contract](ONYX_COLLECTION_BOOK_TEMPLATE.md), [production guide](COLLECTION_BOOK_PRODUCTION_GUIDE.md), [standard](../../03_Standards/Portfolio/ONYX_COLLECTION_BOOK_STANDARD.md), and [sample](../../13%20Production/Samples/P02_Business_Collection_Book_v1/README.md). Do not send internal manifests, source_data or reports to clients.
