...
- ONYX Portrait: **1 фото — 1 000 ₽**, standalone professional portrait for profiles/CV/avatar.
- ONYX Signature ⭐: **10 фото — 3 000 ₽**, recommended compact complete session.
- ONYX Premium: **20 фото — 5 000 ₽**, deeper editorial session within one main Collection.
- Brief optional line: **+1 фото — 500 ₽; срочное выполнение — от +50%; исправление фото — от 500 ₽**.
- Upgrade path may be explained after interest: each next tier +2000 RUB within 7 calendar days, subject to context/consent availability and policy conditions.

Do not use a Signature-only 3000-RUB entry headline, trial/demo positioning, unlimited revisions, guaranteed urgency, all-candidates delivery, or several full Collections included in Premium. Do not put the complete Price Book on a slide.
...
Next production step: prepare ONYX Avito Launch Pack v1 and have the owner approve the actual assets, offer and client replies before publication. Apply the documented payment flow per accepted order.
